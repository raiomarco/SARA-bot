...
$url = '/marco/faculdade/chatbot/chatbot/conversation_start.php';
/*
...
<head>
    ...
    <title>Interface de Testes</title>
...
<div class="centerthis">
    <form method="post" name="talkform" id="talkform" action="index.php">
        <div id="chatdiv">
            <label for="submit">Mensagem:</label>
